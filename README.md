...
Open the local Shopware checkout as project in Codex and use the prompt below to install the Figma Make overlay.
...
Open this repository in Codex and use the prompt below to set up the Figma Make overlay.
